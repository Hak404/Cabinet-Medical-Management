...
<jsp:include page="/shared/navbar.jsp">
    <jsp:param name="title" value="Analyses"/>
    ...
    <main class="app-main">
        <div class="container-fluid px-0">
            <div class="cm-card p-3 mb-3">
                <form method="get" action="<%= ctx %>/medecin/analyses" class="row g-2 align-items-end">
            ...
            <div class="cm-card">
                <div class="card-header p-3 fw-bold">Analyses demandées du ${selectedDate}</div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead><tr><th class="ps-3">Patient</th><th>Code analyse</th><th>Consultation</th></tr></thead>
                            <tbody>
                            <c:forEach items="${analyses}" var="a">
                                <tr>
                                    <td class="ps-3">${a.patientNomComplet}</td>
                                    <td>${a.codeAnalyse}</td>
                                    <td>#${a.consultationId}</td>
                                </tr>
                            </c:forEach>
                            <c:if test="${empty analyses}">
                                <tr><td class="ps-3 text-muted" colspan="3">Aucune analyse demandée ce jour.</td></tr>
                            </c:if>
                            </tbody>
                        </table>
                    </div>
