...
/**
 * Contrôleur MVC de la liste des ordonnances du médecin.
 *
 * <p>Mappé sur {@code @WebServlet("/medecin/ordonnances")}. Interroge
 * {@link OrdonnanceDAO} et {@link MedecinDAO}, puis transfère vers
 * {@code /medecin/ordonnances.jsp}.</p>
 */
...
public class MedecinOrdonnancesServlet extends HttpServlet {
    ...
    /**
     * Affiche les ordonnances émises pour la date sélectionnée.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/medecin/ordonnances.jsp").forward(request, response);
    }
