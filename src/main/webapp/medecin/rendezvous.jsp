...
<head>
    ...
    <title>Médecin - Rendez-vous</title>
...
<jsp:include page="/shared/navbar.jsp">
    <jsp:param name="title" value="Rendez-vous"/>
    ...
    <main class="app-main">
        <div class="container-fluid px-0">
            <div class="cm-card p-3 mb-3">
                <form method="get" action="<%= ctx %>/medecin/rendezvous" class="row g-2 align-items-end">
                    <div class="col-md-4">
            ...
            <div class="cm-card">
                <div class="card-header p-3 fw-bold">Rendez-vous du ${selectedDate}</div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead><tr><th class="ps-3">Patient</th><th>Heure</th><th>Statut</th><th>Actions</th></tr></thead>
                            <tbody>
                            <c:forEach items="${rdvs}" var="r">
                                <tr>
                                    <td class="ps-3">${r.patientNomComplet}</td>
                            ...
                            <c:if test="${empty rdvs}">
                                <tr><td class="ps-3 text-muted" colspan="4">Aucun rendez-vous ce jour.</td></tr>
                            </c:if>
                            </tbody>
                        </table>
                    </div>
